...
int spi_chip_detected = 0; /* if support others flash types try others if spi not detected */
#else
int spi_chip_detected = 1; /* if support only spi and chip not detected try boot with defaults parameters */
#endif
