...
#if defined(CONFIG_WIRELESS_EXT) || defined(CONFIG_IEEE80211) || defined(CONFIG_AX25) || defined(CONFIG_AX25_MODULE)
# if 1
...
#define NETIF_F_GEN_CSUM	(NETIF_F_HW_CSUM | NETIF_F_HW_CSUM)
