...
int show_mib_counters(unsigned int cmd)
{
	...
	case RTL8367M_IOCTL_STATUS_CNT_PORT_LAN4:
		...
		printf("%s MIB counters:\n"
			...
			"  ifOutOctets: %llu\n"
			"  ifOutUcastPkts: %lu\n"
			"  ifOutMulticastPkts: %lu\n"
			"  ifOutBrocastPkts: %lu\n"
			"  etherStatsOctets: %llu\n"
			"  etherStatsMcastPkts: %lu\n"
			"  etherStatsBcastPkts: %lu\n"
			"  etherStatsFragments: %lu\n"
			"  etherStatsJabbers: %lu\n"
			"  etherStatsDropEvents: %lu\n"
			"  etherStatsUndersizePkts: %lu\n"
			"  etherStatsOversizePkts: %lu\n"
			"  etherStatsCollisions: %lu\n"
			"  dot3StatsFCSErrors: %lu\n"
			"  dot3StatsSymbolErrors: %lu\n"
			"  dot3ControlInUnknownOpcodes: %lu\n"
			"  dot3InPauseFrames: %lu\n"
			"  dot3OutPauseFrames: %lu\n"
			"  dot1dTpPortInDiscards: %lu\n"
			"  dot1dBasePortDelayExceededDiscards: %lu\n"
			,
			portname,
			mibc->ifInOctets,
			mibc->ifInUcastPkts,
